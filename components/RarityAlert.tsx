...
const RarityAlert: React.FC<RarityAlertProps> = ({ note }) => {
  return (
    <div className="mb-8 p-4 bg-amber-100/60 border-l-4 border-amber-500 rounded-r-lg" role="alert">
      <div className="flex">
        <div className="py-1">
          <svg className="fill-current h-6 w-6 text-amber-600 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
